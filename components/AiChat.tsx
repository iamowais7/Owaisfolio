      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-40 sm:bottom-24 right-3 sm:right-6 z-55 w-[92vw] sm:w-95 flex flex-col rounded-2xl overflow-hidden"
      ...
      <AnimatePresence>
        {showPopup && !open && (
          <motion.div
            ...
            className="fixed bottom-40 sm:bottom-24 right-3 sm:right-6 z-55 max-w-55 pointer-events-none"
          >
